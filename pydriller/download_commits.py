...
BUCKET_PATH = f"s3://rilldata/github-analytics/{REPO_SLUG}/commits"
#GCP_SERVICE_ACCOUNT_KEY_FILE = "gcp-key-API.json"
...
def write_list_to_s3(list, filename):
...
def download_commits():
    ...
    write_list_to_s3(commits, "commits")
    write_list_to_s3(modified_files, "modified_files")
